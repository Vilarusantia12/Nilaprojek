            ...
            <h5 class="row col s6">Perbarui Identitas Tanaman</h5>
                    <form action="editphp.php?del=<?php echo $id ; ?>" method="post" class="col s12" enctype="multipart/form-data">
                        ...
                        <p>
                            ...
                            <input name="jenis" type="radio" id="pupuk_urea"value="pupuk_urea" <?= $data['Jenis_Tanaman'] == 'nitrogen' ? 'checked' : '' ?>/>
                            <label for="pupuk_urea">Pupuk Nitrogen (N)</label>
                        </p>
                        <p>
                            <input name="jenis" type="radio" id="fosfor" value="fosfor"<?= $data['Jenis_Tanaman'] == 'fosfor' ? 'checked' : '' ?> />
