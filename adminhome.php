...
<head>
    <title>Pupuk Bawang Merah-Belanja Pupuk Mudah dan Aman</title>
    ...
    Panel Utama
                ...
                <div class="row">
                    <div class="card col s4">
                        ...
                        <h5 class="pink white-text">Pupuk Dijual</h5>
                    ...
                    <div class="card col s4">
                        ...
                        <h5 class="teal white-text"> Stok Pupuk Tersedia</h5>
                        <h4><?php echo $jumlah ?> Pupuk</h4>
                    </div>
                    <div class="card col s4">
                ...
                <div class="row">
                    <div class="card col s4">
                        <h5 class="brown white-text"> Pupuk Terlaris </h5>
                        <?php $no=0;
